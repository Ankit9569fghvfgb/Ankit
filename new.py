...
bot = telebot.TeleBot('7545806414:AAF9zs6Ji0ndQOg5LDOtp17uOXHZiBRvT9o')
...
def welcome_start(message):
    ...
    response = f'''WELCOME {user_name} TO REFLEX x YK VIP DDoS
🤖TO FREEZ SERVER :- /bgmi  
✅DDOS BY :- @VIPxMODS'''
    bot.reply_to(message, response)
...
def broadcast_message(message):
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            response = "🤖 https://t.me/reflexddos."
    else:
        response = "ONLY OWNER CAN USE."
